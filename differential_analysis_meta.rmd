...
test2 <- data.frame(MIMAT = DE,  miRNAname = paste(feature, sep = ",", collapse = ","), FC = test_st, pval)
test <- rbind(test, test2)
}
test$adj.P.Val=p.adjust(test$pval, method="BH")
test = test[order(test$pval),]
write.table(test, "output-analysis/difflists_meta/DCIS_to_normal_limma.txt", sep = "\t", quote = FALSE)
...
test$adj.P.Val=p.adjust(test$pval, method="BH")
test = test[order(test$pval),]
write.table(test, "output-analysis/difflists_meta/DCIS_to_invasive_limma.txt", sep = "\t", quote = FALSE)
results_pval1 <- metaMA(all_normnal_to_benign, varname = "status", moderated = "limma",   which = "pval", BHth = 0.05)
```
...
test$adj.P.Val=p.adjust(test$pval, method="BH")
test = test[order(test$pval),]
write.table(test, "output-analysis/difflists_meta/benign_to_normal_limma.txt", sep = "\t", quote = FALSE)
...
test$adj.P.Val=p.adjust(test$pval, method="BH")
test = test[order(test$pval),]
write.table(test, "output-analysis/difflists_meta/dcis_to_lumA_limma.txt", sep = "\t", quote = FALSE)
...
test$adj.P.Val=p.adjust(test$pval, method="BH")
test = test[order(test$pval),]
write.table(test, "output-analysis/difflists_meta/dcis_to_lumB_limma.txt", sep = "\t", quote = FALSE)
write.table(test, "output-analysis/difflists_meta/dcis_to_lumB_limma.txt", sep = "\t", quote = FALSE)
...
test$adj.P.Val=p.adjust(test$pval, method="BH")
test = test[order(test$pval),]
write.table(test, "output-analysis/difflists_meta/dcis_to_her2_limma.txt", sep = "\t", quote = FALSE)
...
test$adj.P.Val=p.adjust(test$pval, method="BH")
test = test[order(test$pval),]
write.table(test, "output-analysis/difflists_meta/dcis_to_normal_like(invasive)_limma.txt", sep = "\t", quote = FALSE)
...
test$adj.P.Val=p.adjust(test$pval, method="BH")
test = test[order(test$pval),]
write.table(test, "output-analysis/difflists_meta/basallike_to_dcis_limma.txt", sep = "\t", quote = FALSE)
...
test$adj.P.Val=p.adjust(test$pval, method="BH")
test = test[order(test$pval),]
write.table(test, "output-analysis/difflists_meta/dcis_to_HER2neg_ERneg_PGRneg_limma.txt", sep = "\t", quote = FALSE)
ults_pval1 <- metaMA(  all_dcis_HER2neg_ERpos, varname = "ihc", moderated = "limma",   which = "pval", BHth = 1) 
```
...
test$adj.P.Val=p.adjust(test$pval, method="BH")
test = test[order(test$pval),]
write.table(test, "output-analysis/difflists_meta/dcis_to_HER2neg_ERpos_limma.txt", sep = "\t", quote = FALSE)
...
test$adj.P.Val=p.adjust(test$pval, method="BH")
test = test[order(test$pval),]
write.table(test, "output-analysis/difflists_meta/dcis_to_HER2pos_ERneg_limma.txt", sep = "\t", quote = FALSE)
...
test$adj.P.Val=p.adjust(test$pval, method="BH")
test = test[order(test$pval),]
write.table(test, "output-analysis/difflists_meta/dcis_to_HER2pos_ERpos_limma.txt", sep = "\t", quote = FALSE)
```
