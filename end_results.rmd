...
write.table(signchangetab, file=paste(consensusdir, "/signchangetab", postfix, sep=""),
...
fn = paste(consensusdir, "/subtypecorrelation", postfix, sep="")
write("Count of significant microRNAs found going in the same direction for the subtypes", file=fn)
write.table(correlationmatrix1, file=fn,quote=FALSE, sep="\t", col.names=NA, na="X", append=TRUE)
write("\n\n\nCount of significant microRNAs found going in the opposite direction for the subtypes", file=fn, append=TRUE)
...
expressed =	table(curatedtab$status[curatedtab$MIMAT %in% filt1])
nonexpressed=	table(curatedtab$status[curatedtab$MIMAT %in% unfilt1[!unfilt1 %in% filt1]])
